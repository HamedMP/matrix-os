...
for skill_dir in animate animation-accessibility animation-performance animation-vocabulary app-builder app-ui-patterns css-animations debug-animation design-system dev-vps debug-app find-animation-opportunities gesture-ui improve-animations integrations landing-design motion-react pick-ui-library review-animations scroll-animations; do
