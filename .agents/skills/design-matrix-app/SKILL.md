...
description: UX/UI design guidelines for Matrix OS apps Triggers: design app, app design, app layout, ui guidelines, ux patterns. Examples: how should I design my matrix os app; what are the ui guidelines; best practices for app layout.
---
...
- **Category**: builder
- **Channels**: web
- **Composable with**: build-for-matrix, app-builder
- **Example prompts**: how should I design my matrix os app; what are the ui guidelines; best practices for app layout; how to make my app look native
