---
name: setup-wizard
description: Re-run onboarding to reconfigure your OS for a new role or fresh start Triggers: reconfigure, re-onboard, setup wizard, start fresh, change role, new career.
---
