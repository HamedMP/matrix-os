...
description: Build data visualization dashboards with charts, tables, and KPI cards Triggers: dashboard, analytics, charts, data visualization, metrics. Examples: build me a fitness dashboard; create an analytics dashboard for my expenses; make a dashboard to track my reading progress.
---
...
- **Example prompts**: build me a fitness dashboard; create an analytics dashboard for my expenses; make a dashboard to track my reading progress
