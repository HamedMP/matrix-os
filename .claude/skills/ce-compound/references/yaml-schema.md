...
- **component**: One of `gateway_route`, `platform_control_plane`, `shell_ui`, `sync_client_cli`, `kernel_agent`, `kysely_repository`, `postgres_schema`, `symphony_runtime`, `elixir_service`, `default_app`, `observability_dashboard`, `release_workflow`, `database`, `assistant`, `authentication`, `payments`, `development_workflow`, `testing_framework`, `documentation`, `tooling`
