...
- [x] T092 [P] [US1] (PR5) Write red inherited existing/new file/Chat/app/layout/terminal creation tests in `tests/gateway/collaboration-project-inheritance.test.ts`
