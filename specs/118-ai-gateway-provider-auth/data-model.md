...
Describes an execution harness or transport implementation.
...
A concrete driver configuration that can execute a Chat turn.
...
| `accountId` | optional ProviderAccount ID | Null for Matrix-funded access |
