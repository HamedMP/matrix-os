...
- Focused existing suites passed during extraction: 38 main WebSocket tests; 17 voice/onboarding WebSocket tests; 81 channel startup tests; 29 coding-agent thread tests; 34 message/layout tests; 78 home utility tests; 98 system operator tests; shell/terminal focused suites after the source-inspection fix; 59 operational tests; 41 canvas tests; and 92 app runtime, integration, metrics, and Chat tests. These runs overlap; the counts are not a deduplicated total.
