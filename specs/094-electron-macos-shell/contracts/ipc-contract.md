...
|---|---|---|---|
| `auth:start-device-flow` | `{intent?: "sign-up" | "sign-in"}` | `{userCode, verificationUri, expiresIn}` | main returns the matching Clerk approval URL; renderer opens the system browser |
