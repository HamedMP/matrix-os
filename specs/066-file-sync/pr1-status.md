...
- [~] PR 30 review remediation in progress — tracker: `specs/066-file-sync/pr-review.md` (latest blocker wave addressed locally; gateway blocker regressions `29/29` pass, Docker platform blocker regressions `71/71` pass, plus prior gateway identity `9/9` and sync-client `30/30` follow-up suites remain green)
