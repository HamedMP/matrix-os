...
- [~] PR 30 review remediation in progress — tracker: `specs/066-file-sync/pr-review.md` (latest auth/platform/sync-client follow-up wave addressed locally; gateway `9/9`, sync-client `30/30`, and Docker platform `18/18` targeted regressions pass)
