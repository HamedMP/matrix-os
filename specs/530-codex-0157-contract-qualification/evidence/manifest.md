...
Remaining before this PR is review-ready: current-head actual `linux-x64` and `darwin-arm64` schema workflow results, review of all 11 printed transitive digests against the contract, then Greptile 5/5 and label-triggered CI. No installed version or customer-runtime claim follows from contract qualification.
