...
**Branch stack**: `spec/coding-agent-shells` plus stacked implementation branches through `105-coding-agent-attention-notifications`
**Updated**: 2026-07-07
...
- Thread-event sinks can bridge approval, input, and failed attention events to the existing push channel with generic copy and bounded `threadId` metadata only.
