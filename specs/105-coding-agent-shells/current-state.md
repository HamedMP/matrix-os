...
- The Electron badge count includes the gateway-owned bounded coding-agent attention-thread count plus existing local thread attention, while the summary data remains owned by the gateway/runtime.
