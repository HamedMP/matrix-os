...
| Mobile SDK 57 coding-agent workspace and phone-first routes | `apps/mobile/app/agents/index.tsx`; `apps/mobile/app/agents/project/[projectId].tsx`; `apps/mobile/app/agents/project/[projectId]/board.tsx`; `apps/mobile/app/agents/[threadId].tsx`; `apps/mobile/components/AgentProjectWorkspaceScreen.tsx`; focused tests listed under Phase 22 in `acceptance-tests.md` | Implemented; physical-device gate pending |
...
- PR #911, `266e6af9317287acdfdb58b49b8f4adfa73e5aff`, implements project-first routes, bounded safe-reference persistence, hydration, and stale-reference reconciliation. Its mobile run passed 36 suites / 379 tests, mobile lint and TypeScript passed, focused backend/handoff coverage passed 29 files / 296 tests, and Greptile reported 5/5.
- PR #912, `5c7319467d3dc88d216319764fb56c4b6b9c6f09`, implements the capability-gated same-thread turn composer, retry/idempotency/offline recovery, and project-aware new-chat creation. Its mobile run passed 36 suites / 390 tests, the focused contract run passed 16 tests, mobile lint and TypeScript passed, and Greptile reported 5/5.
- PR #913, `e8862daa7f9ea51c10aab19181f68c4c010fc48f`, implements Conversation/Kanban routing, canonical task columns, bounded aggregates, multi-thread routing, tablet-width rendering, and cross-view identity continuity. Its mobile run passed 38 suites / 404 tests, the focused contract run passed 8 tests, mobile lint and TypeScript passed, and Greptile reported 5/5.
- PR #914, `00909ccf843130761da215bde83f458dc059cca4`, adds the authenticated computer projection and native chooser needed to test the stack on the disposable preview computer. Focused chooser coverage passed 5 tests; mobile lint, mobile TypeScript, root typecheck, pattern scan, platform routing, Cloud Run packaging, and host-bundle workflow tests passed; Greptile reported 5/5.
