...
- PR #914, `3e4b9c26922f4e43bdb3859961af3d894eaf637e`, adds the authenticated computer projection and native chooser needed to test the stack on the disposable preview computer and contains the exact current lower stack as ancestors. The canonical-origin mobile run passed 41 suites / 420 tests; mobile lint and TypeScript passed. Neo checks and the stack/title gate pass; exact-head preview build and Greptile re-review are pending.
