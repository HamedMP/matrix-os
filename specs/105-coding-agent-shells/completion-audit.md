...
| Runtime summary hydrates real canonical projects and bounded task/thread projections | Runtime summary now hydrates bounded canonical owner project summaries; the authenticated project workspace projection remains unimplemented | **Incomplete** |
