...
8. `feat(vps): activate golden snapshot clones`
9. `feat(platform): provision VPSes from golden snapshots`
10. `feat(platform): recover and retire golden snapshots`
11. `ci(release): create snapshots for eligible host bundles`
12. `docs(vps): document snapshot operations and rollout`
