...
import {
  ...
  CursorSchema,
  DesktopSyncFolderSelectionSchema,
  DesktopSyncMappingMutationRequestSchema,
...
export const INVOKE_CHANNELS = {
  ...
  "sync:enable": { request: DesktopSyncMappingSetupRequestSchema, response: DesktopSyncSnapshotSchema },
  "sync:add-mapping": { request: DesktopSyncMappingSetupRequestSchema, response: DesktopSyncSnapshotSchema },
  "sync:pause-mapping": { request: DesktopSyncMappingMutationRequestSchema, response: DesktopSyncSnapshotSchema },
  "sync:resume-mapping": { request: DesktopSyncMappingMutationRequestSchema, response: DesktopSyncSnapshotSchema },
  "sync:remove-mapping": { request: DesktopSyncMappingMutationRequestSchema, response: DesktopSyncSnapshotSchema },
  "sync:rescan": {
    request: z.object({ mappingId: z.uuid().optional() }).strict(),
    response: DesktopSyncSnapshotSchema,
  },
  "sync:set-enabled": {
