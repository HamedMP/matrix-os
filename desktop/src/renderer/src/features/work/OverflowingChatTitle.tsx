    ...
    >
      <span
        ...
        className={`block w-max max-w-none whitespace-nowrap ${overflowing
          ? "motion-safe:group-hover/chat:animate-[chat-title-scroll_4s_ease-in-out_infinite_alternate] motion-safe:group-focus-within/chat:animate-[chat-title-scroll_4s_ease-in-out_infinite_alternate]"
          : ""}`}
      >
        {title}
      </span>
