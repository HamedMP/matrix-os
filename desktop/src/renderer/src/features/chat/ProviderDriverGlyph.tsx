...
export function ProviderDriverGlyph({
  kind,
  size = 15,
}: {
  kind: CanonicalProviderDriverKind;
  ...
  if (kind === "claude_code") {
    return (
      <GlyphFrame kind={kind} size={size}>
  ...
  if (kind === "opencode") {
    return (
      <GlyphFrame kind={kind} size={size} viewBox="0 0 300 300">
        <path d="M210 240H90V120H210V240Z" fill="var(--bg-overlay)" />
  ...
  if (kind === "pi") {
    return (
      <GlyphFrame kind={kind} size={size} viewBox="0 0 800 800">
        <rect width="800" height="800" rx="120" fill="currentColor" />
        <path fill="var(--bg-overlay)" fillRule="evenodd" d="M165.29 165.29H517.36V400H400V517.36H282.65V634.72H165.29ZM282.65 282.65V400H400V282.65Z" />
        <path fill="var(--bg-overlay)" d="M517.36 400H634.72V634.72H517.36Z" />
      </GlyphFrame>
    );
  }
