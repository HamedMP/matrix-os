...
export function registerIpcHandlers(ipcMain: IpcMainLike, ctx: HandlerContext): void {
  ...
  handle("runtime:get-provider-usage", (request) => ctx.fetchProviderUsage(request));
