...
- Rust1.98.1 locked build completed; shipped asset/source hashes are tested. Full repository suite is tracked in the PR description.
- React Doctor latest requests project installation; the runnable pinned0.0.29 scan reports broader existing-file findings (shell85errors/117warnings, Electron3errors/88warnings). This is not a clean React Doctor result and has not been compared against an untouched base.
...
| Web Canvas | Same component at0.75zoom |
