...
**Hermes** — Matrix's always-on chat agent. It runs in the background and replies across web chat, mobile, and messaging channels. Hermes needs a [Claude login](/docs/hermes) to respond.
