...
sequenceDiagram
    ...
    Disp->>Disp: Queue + create task in PostgreSQL
...
<Cards>
  ...
  <Card
    title="Integrations"
    description="Connect Gmail, Calendar, GitHub, Slack, Discord and use them from conversation"
    href="/docs/guide/integrations"
  />
  <Card
    title="Apps"
    description="App runtime, pre-installed games, utilities, and bundled desktop apps"
    href="/docs/guide/apps"
  />
  <Card
    title="App Store"
    description="Browse, install, publish, and fork apps. Personal websites."
    href="/docs/guide/app-store"
  />
  <Card
    title="Storage"
    description="S3 backup, git versioning, and PostgreSQL databases"
    href="/docs/guide/storage"
  />
  <Card
    title="Social"
    description="Social feed, messaging, Matrix protocol federation"
    href="/docs/guide/social"
  />
</Cards>
