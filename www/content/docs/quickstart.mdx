...
<Steps>
  ...
  <Step>
    ...
    Matrix creates a Hetzner VPS, boots the OS image, and registers the machine. The onboarding screen tracks progress through four stages: creating server, booting, registering, and finalizing. Provisioning typically takes two to four minutes.
...
## Let your coding agent drive setup
...
6. For SSH repository access, use a Matrix-managed key created inside the runtime. Register only the public key with GitHub. Do not use local private keys.
