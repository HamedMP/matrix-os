...
description: Technical reference for building on, operating, and contributing to Matrix OS.
---

import { Card, Cards } from 'fumadocs-ui/components/card';
import { Callout } from 'fumadocs-ui/components/callout';

This section covers Matrix OS for contributors who want to understand the architecture, contribute to the project, build apps, operate dev VPSes, or extend the agent/skill system.
...
<Cards>
  <Card
    title="Dev VPS"
    description="Develop Matrix inside a user/dev VPS with hot reload, previews, tunnels, and runtime caveats."
    href="/docs/developer/dev-vps"
  />
  <Card
    title="Agent Matrix Skills"
    description="Canonical Matrix skills for Claude, Codex, Hermes, Agent, and the Matrix kernel."
    href="/docs/developer/agent-skills"
  />
  <Card
    title="Architecture"
  ...
  <Card
    title="Skills System"
    description="Skill validation, caching, composable skills, and build pipeline optimization."
    href="/docs/developer/skills"
  />
  <Card
    title="Logging & Usage"
    description="Kernel logging, token tracking, usage API, file audit trail."
    href="/docs/developer/logging"
  />
  <Card
    title="Testing"
  ...
  <Card
    ...
    description="Pre-PR checks, React audit, pattern scanning, and review passes."
    href="/docs/developer/review-pipeline"
  />
  <Card
    title="Releases"
    description="Host bundles, channels, customer VPS updates, and verification."
    href="/docs/developer/releases"
  />
  <Card
    title="Contributing"
