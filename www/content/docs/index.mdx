...
<Cards>
  ...
  <Card
    title="Apps"
    description="App runtime, pre-installed games, utilities, bundled desktop apps, and AI skills for building."
  ...
  <Card
    title="Social"
    description="Social feed, follow system, messaging, Matrix protocol federation."
