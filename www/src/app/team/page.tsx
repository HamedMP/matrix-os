...
const founders = [
  ...
  },
  {
    name: "Nima Naderi",
    role: "CTO & Co-Founder",
    bio: "Nima brings security and engineering depth to Matrix OS, shaped by Olympiad gold-medal problem solving, two years as part of the IOI Scientific Committee, and experience as a DEF CON finalist. He focuses on reliable systems, polished interfaces, and the details that make AI feel native.",
    logos: [
      {
