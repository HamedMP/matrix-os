...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Simplicity Over Sophistication.} Single-process async before worker threads. File-based IPC before message queues. Owner-local Postgres before external data services. Escalate complexity only when the simpler approach fails.
