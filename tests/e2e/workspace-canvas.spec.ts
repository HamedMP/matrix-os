...
test.describe("workspace canvas smoke", () => {
  test("opens a seeded PR canvas and preserves terminal node identity", async ({ page }) => {
    ...
    await page.route("**/api/canvases/cnv_seed", async (route) => {
      await route.fulfill({ json: { document: { id: "cnv_seed", title: "Seed PR", revision: 1, schemaVersion: 1, scopeType: "pull_request", scopeRef: {}, nodes: [{ id: "node_terminal", type: "terminal", position: { x: 100, y: 100 }, size: { width: 320, height: 180 }, zIndex: 0, displayState: "normal", sourceRef: { kind: "terminal_tab", terminalRef: { workspaceId: "tws_00000000000000000000000000000001", tabId: "tt_00000000000000000000000000000001" } }, metadata: { label: "Terminal" } }], edges: [], viewStates: [], displayOptions: {} }, linkedState: {} } });
    });
