...
import { fonts, palette as c } from "@matrix-os/brand";
...
const AGENTS = [
  ...
  { name: "Hermes", logo: "/logo-rabbit.png" },
] as const;
  ...
  return (
    <div className="mb-8 flex items-center gap-3">
      <ShellImage
        ...
        width={34}
        height={34}
        className="size-[34px] rounded-lg border object-contain p-1.5"
            ...
            <div className="p-3.5" style={{ backgroundColor: c.card }}>
              ...
              <div className="mt-2.5 flex flex-col gap-2 text-[12px]" style={{ color: c.deep }}>
                <span className="flex items-center gap-2">
                  <span className="size-1.5 rounded-full bg-[#639922]" />
                  Claude · running
                </span>
                <span className="flex items-center gap-2">
                  <span className="size-1.5 rounded-full bg-[#639922]" />
