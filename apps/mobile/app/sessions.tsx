    ...
    <View style={styles.screen}>
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        <Pressable accessibilityRole="button" accessibilityLabel="Close" onPress={() => router.back()} style={styles.iconButton}>
          <Ionicons name="chevron-down" size={20} color={L.ink} />
        </Pressable>
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          <Ionicons name="terminal-outline" size={30} color={L.inkDim} />
          ...
          <Pressable accessibilityRole="button" onPress={createSession} style={styles.emptyCta}>
            <Ionicons name="add" size={17} color={L.accentInk} />
  ...
  return (
    <Pressable accessibilityRole="button" accessibilityLabel={`Open ${session.sessionId}`} onPress={onOpen} style={styles.row}>
      ...
      <View style={styles.rowBody}>
        ...
        {onDesktop ? (
          <View style={styles.desktopBadge}>
            <Ionicons name="desktop-outline" size={12} color={L.accentInk} />
      ...
      <Pressable accessibilityRole="button" accessibilityLabel={`End ${session.sessionId}`} onPress={onEnd} hitSlop={10} style={styles.endButton}>
        <Ionicons name="ellipsis-horizontal" size={18} color={L.inkDim} />
      </Pressable>
    </Pressable>
  );
}
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.sansBold, fontSize: 22, letterSpacing: -0.4, color: L.ink },
  subtitle: { marginTop: 2, fontFamily: fonts.mono, fontSize: 12, color: L.inkMuted },
  newButton: {
    width: 40,
    height: 40,
    alignItems: "center",
  ...
  emptyTitle: { fontFamily: fonts.sansBold, fontSize: 17, color: L.ink },
  emptySubtitle: { textAlign: "center", fontFamily: fonts.sans, fontSize: 13, lineHeight: 19, color: L.inkMuted },
  emptyCta: {
    marginTop: 6,
    flexDirection: "row",
    alignItems: "center",
  ...
  emptyCtaText: { fontFamily: fonts.sansSemiBold, fontSize: 15, color: L.accentInk },
  sectionLabel: {
  ...
  row: {
    ...
    paddingLeft: 20,
    borderTopWidth: 1,
    borderTopColor: L.lineSoft,
  },
  dotLane: { width: 20, paddingTop: 3, alignItems: "center" },
  dot: { width: 9, height: 9, borderRadius: 999 },
  rowBody: { flex: 1, minWidth: 0, gap: 5 },
  rowTitle: { flexShrink: 1, fontFamily: fonts.sansSemiBold, fontSize: 15, letterSpacing: -0.15, color: L.ink },
  statusText: { fontFamily: fonts.mono, fontSize: 12, color: L.inkMuted },
  statusWaiting: { fontFamily: fonts.monoBold, color: L.glow },
  desktopBadge: {
  ...
  desktopText: { fontFamily: fonts.sansMedium, fontSize: 11, color: L.accentInk },
