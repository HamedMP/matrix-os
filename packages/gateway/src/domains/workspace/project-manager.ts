...
import { atomicWriteJson, readJsonFile, withProjectLock, type OwnerScope } from "../files/state-ops.js";
import { containsDeniedFileApiPath, resolveExistingFileApiPath } from "../../_shared/path-security.js";
