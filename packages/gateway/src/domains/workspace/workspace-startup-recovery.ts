...
import { createAgentSessionManager, type AgentSessionStartupReconciliation, type WorkspaceSessionView } from "../sessions/agent-session-manager.js";
...
import { createSessionTranscriptManager } from "../sessions/session-transcript.js";
import { createStateOps } from "../files/state-ops.js";
...
export function createWorkspaceStartupRecovery(options: {
  ...
  return {
    ...
    close: () => { agentSessionManager.shutdown(); },
  };
}
