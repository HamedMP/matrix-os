...
import { isMatrixManagedProjectSource } from "../workspace/project-registry-layout.js";
import type { ProjectRegistry } from "../workspace/project-registry.js";
import {
  listValidatedLegacyProjectStateFiles,
  removeValidatedLegacyProjectState,
} from "../workspace/legacy-project-state.js";
import { projectStateRecoveryDir } from "../../_shared/bounded-json-file.js";
...
async function getProjectRegistry(homePath: string): Promise<ProjectRegistry> {
  ...
  const { createProjectRegistry } = await import("../workspace/project-registry.js");
