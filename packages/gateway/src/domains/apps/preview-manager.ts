...
import { PROJECT_SLUG_REGEX, type WorkspaceError } from "../workspace/project-manager.js";
import { atomicCreateJson, atomicWriteJson, readJsonFile, type OwnerScope } from "../files/state-ops.js";
