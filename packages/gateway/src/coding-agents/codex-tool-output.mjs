...
/** @param {Record<string, any>} item */
export function codexToolOutput(item, privateContext = false, protection) {
  ...
  return { text: "Tool output is private to its owner.", truncated: bounded.length < text.length,
