...
export const EXPANSION_SERVICE_REGISTRY: Record<string, ExpansionService> = {
  ...
  granola: {
    ...
    logoUrl: "",
    actions: {
      search_notes: { description: "Ask a natural-language question across Granola meeting notes", risk: "read", params: { query: { type: "string", required: true } } },
      list_folders: { description: "List accessible Granola meeting folders", risk: "read", params: {} },
      list_notes: { description: "List Granola meeting notes", risk: "read", params: { folderId: { type: "string" }, timeRange: { type: "string" }, limit: { type: "number" } } },
      get_note: { description: "Get a Granola meeting note", risk: "read", params: { noteId: { type: "string", required: true } } },
      get_transcript: { description: "Get a Granola meeting transcript when available on the connected plan", risk: "read", params: { noteId: { type: "string", required: true } } },
      get_account: { description: "Get the connected Granola account and active workspace", risk: "read", params: {} },
    },
  },
};
