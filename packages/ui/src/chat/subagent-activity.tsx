  ...
  return (
    <div className="flex w-full min-w-0 flex-col text-sm">
      <button type="button" aria-label={view.label} aria-expanded={open} aria-controls={detailId}
        ...
        <span aria-hidden className="flex size-6 shrink-0 items-center justify-center rounded-full border border-[var(--border-subtle,var(--border))] bg-[var(--bg-sunken,var(--muted))] text-xs font-medium">
