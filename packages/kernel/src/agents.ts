...
*{margin:0;padding:0;box-sizing:border-box}body{background:linear-gradient(170deg,var(--sand-light) 0%,var(--sand-mid) 30%,#F7F3ED 60%,var(--sand-light) 100%);color:var(--fg);font-family:'Inter',system-ui,sans-serif;min-height:100vh}h1,h2{font-family:'Orbitron',system-ui,sans-serif;color:var(--fg)}h3,h4,h5,h6{font-family:'Inter',system-ui,sans-serif;font-weight:600;color:var(--fg)}button{background:var(--primary);color:var(--primary-fg);border:none;padding:10px 24px;border-radius:50px;cursor:pointer;font-family:'Inter',system-ui,sans-serif;font-size:0.875rem;font-weight:500;transition:all 0.2s}button:hover{transform:translateY(-1px);box-shadow:0 4px 12px rgba(50,53,46,0.1)}input,select{background:var(--card);color:var(--fg);border:1.5px solid var(--border);padding:12px 20px;border-radius:50px;font-family:'Inter',system-ui,sans-serif;width:100%;outline:none;transition:all 0.2s}textarea{background:var(--card);color:var(--fg);border:1.5px solid var(--border);padding:12px 20px;border-radius:var(--radius);font-family:'Inter',system-ui,sans-serif;width:100%;outline:none;transition:all 0.2s}input:focus,textarea:focus,select:focus{border-color:var(--primary);box-shadow:0 0 0 3px rgba(67,78,63,0.08)}
