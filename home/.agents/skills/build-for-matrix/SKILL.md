...
description: Master skill for building Matrix OS apps -- manifest format, lifecycle, bridge API, theming
triggers:
  - matrix app
  - matrix.json
  - app manifest
...
channel_hints:
  - web
examples:
  - how do I create a Matrix OS app
  - explain the matrix.json format
  - how does the app bridge API work
  - what ports can my app use
composable_with:
  - build-react-app
  - build-html-app
  - build-game
